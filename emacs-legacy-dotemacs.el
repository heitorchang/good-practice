;; dotemacs
;; Location: /home/personal/.emacs
;; Windows location: C:/Users/personal/AppData/Roaming/.emacs
...
(defun quick-access-1 () (interactive) (find-file "/home/personal/tmp/my-scratch.txt") (end-of-buffer))
(defun quick-access-C-f1 () (interactive) (find-file "/home/personal/tmp/my-scratch.txt") (end-of-buffer))
(defun quick-access-4 () (interactive) (find-file "/home/personal/code/clojure/myclojure/project.clj"))
...
(global-set-key (kbd "<C-f2>") ; or C-f2
                (lambda () (interactive) (progn (find-file-read-only "/home/personal/cljrepl/project.clj")
...
(setq default-directory "/home/personal/")

;; window size and position
(setq initial-frame-alist '((top . 52) (left . 1420) (width . 77) (height . 68)))
...
;; leim
;; (add-to-list 'load-path "/home/personal/my-emacs/lisp/")
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(paredit smartparens scala-mode rjsx-mode ## vlf js2-mode slime use-package isend-mode cider clojure-mode web-mode vue-html-mode ssass-mode pyvenv mmm-mode edit-indirect auto-complete))
...
(setenv "PYTHONPATH" "/home/personal/code/shared/python/my-modules:/home/personal/tok_data")
...
;; (setq scheme-program-name "/usr/local/bin/mit-scheme --load /home/personal/code/shared/scheme/personal.scm")
(setq scheme-program-name "/usr/bin/csi -:c")
